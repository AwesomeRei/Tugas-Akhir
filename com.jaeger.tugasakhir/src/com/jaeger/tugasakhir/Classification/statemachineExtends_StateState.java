...
public class statemachineExtends_StateState
    extends statemachineClassificationState
{
    private final static statemachineExtends_StateState instance = new statemachineExtends_StateState();

    /**
     * Protected Constructor
     */
    protected statemachineExtends_StateState() {
        setName("Extends_State");
    ...
    public void onEntry(statemachineContext context) {
        ...
        action.doPrint("Entering Extends");
    }
    ...
    public void evUnknown(statemachineContext context) {
        ClassificationAction action = context.getClassificationAction();
        // Transition from Extends_State to Name_Identifier_State triggered by evUnknown
