...
public class statemachineImplements_StateState
    extends statemachineClassificationState
{
    private final static statemachineImplements_StateState instance = new statemachineImplements_StateState();

    /**
     * Protected Constructor
     */
    protected statemachineImplements_StateState() {
        setName("Implements_State");
    ...
    public void onEntry(statemachineContext context) {
        ...
        action.doPrint("Entering Implements");
    }
    ...
    public void evUnknown(statemachineContext context) {
        ClassificationAction action = context.getClassificationAction();
        // Transition from Implements_State to Name_Identifier_State triggered by evUnknown
